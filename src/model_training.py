...
import argparse
from utils import log_1px_transform, siren_model, scheduler
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--batch_size", type=int, default=2048, help="batch size")
    ...
    model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
        filepath=args.model_path, save_weights_only=False, monitor="val_loss", mode="min", save_best_only=True
    )
